...
# define logger_get_cat(priority)  \
    return ((__logger_cat_global && log4c_category_is_priority_enabled(__logger_cat_global, priority))? __logger_cat_global : NULL)

# define logger_write(priority, file, line, func, msg) \
